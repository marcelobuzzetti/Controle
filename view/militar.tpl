        ...
        <div class = "panel panel-primary">
            ...
            <div class = "panel-body collapse in" id="dados_militares">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4">
                    ...
                    <input class="form-control data" type="text" id="data_nascimento_conjuge" name="data_nascimento_conjuge" placeholder="Data Nascimento Cônjuge"  maxlength="20" value="{$data_nascimento}" tabindex="19"/>
                </div>
            </div>
        </div>
        <div class = "panel panel-primary">
            ...
            <div class = "panel-body collapse in" id="contatos">     
                <div id="telefones">
                    <div class="form-group col-xs-12 col-sm-6 col-md-6">
                        ...
                        <input class="form-control" type="text" id="tipo_telefone" name="tipo_telefone[]" placeholder="Tipo" value="{$estado}" tabindex="26"/>
                    </div>                
                    <div class="form-group col-xs-12 col-sm-6 col-md-6">
                        <label for="telefone">Telefone</label>
                        <input class="form-control" type="text" id="telefone" name="telefone[]" placeholder="Telefone" value="{$estado}" tabindex="26"/>
                    </div>
                </div>

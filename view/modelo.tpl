<div class='container'>
    ...
    <form autocomplete="off" action="executar" method="post">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-3">
            ...
            <input class="form-control" type="number" id="cap_tanque" name="cap_tanque" placeholder="Capacidade Tanque" required="required" min="1" step="1" value="{$cap_tanque}" tabindex="3"/>
        </div>
        <div class="form-group col-xs-12 col-sm-6 col-md-3">
            <label for="consumo">Consumo</label>
            <input class="form-control" type="number"  id="cons_padrao" name="consumo_padrao" placeholder="Consumo Km/L" required="required" min="1" step="1" value="{$consumo_padrao}" tabindex="4"/>
        </div>
        <div class="form-group col-xs-12 col-sm-6 col-md-3">
            <label for="cap_transp">Capacidade de Transporte</label>
            <input class="form-control" type="number" id="cap_transp" name="cap_transp" placeholder="Cap Transp Pessoas" required="required" min="0" step="1" value="{$cap_transp}" tabindex="5"/>
        </div>

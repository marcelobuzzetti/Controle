<div class='container'>
    ...
    <form autocomplete="off" action="executar" method="post">
        ...
        <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <label for="alteracao">Descrição da Indisponibilidade</label>
            <textarea class="form-control" rows="10" id="alteracao" name="alteracao" placeholder="Descrição da Indisponibilidade" required='required'  tabindex="4">{$descricao}</textarea>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-12">

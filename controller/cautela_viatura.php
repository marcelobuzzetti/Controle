...
if (isset($_SESSION['login']) == FALSE || ($_SESSION['perfil'] != 1 && $_SESSION['perfil'] != 3 && $_SESSION['perfil'] != 4)) {
    ...
    $cautela = new CautelaVtr();
    $relacao_cautela = $cautela->listarCautelaVtr();
    ...
    if (!isset($_POST['id'])) {
        ...
        $smarty->assign('titulo', 'Cadastrar Cautela de Viaturas');
        $smarty->assign('botao', 'Cadastrar');
        $smarty->assign('evento', 'cadastrar_cautela');
        $smarty->assign('id_cautela_viatura', '');
        $smarty->assign('odometro', '');
        $smarty->assign('descricao', '');
        $smarty->assign('data', '');
        $smarty->assign('relacao_viaturas', $relacao_viaturas);
        $smarty->assign('relacao_cautela', $relacao_cautela);
        ...
        $smarty->display($menu);
        $smarty->display('cautela_viatura.tpl');
